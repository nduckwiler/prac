          ...
          if (!this.event.request.intent.slots.genre.value) {
            ...
            this.emit(':elicitSlot', slotToElicit, speechOutput, repromptSpeech)
              ...
              if ((genreRequestedByUser == 'comedy') && (videoTypeRequestedByUser == 'movie')){
                ...
                const speechOutput = "Aha. I love comedy movies. I’ve got a really good recommendation for you. Do you want me to tell you the comedy movie I found for you?"
                const repromptSpeech = "So you're looking for a " + genreRequestedByUser + " " + videoTypeRequestedByUser + ", right?"
                this.emit(':confirmIntent', speechOutput, repromptSpeech)
              }
              else{
                const speechOutput = "Just to confirm, you're looking for a " + genreRequestedByUser + " " + videoTypeRequestedByUser + ", right?"
                const repromptSpeech = "So you're looking for a " + genreRequestedByUser + " " + videoTypeRequestedByUser + ", right?"
                this.emit(':confirmIntent', speechOutput, repromptSpeech)
              }
            }
